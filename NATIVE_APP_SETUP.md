...
sudo cp /etc/letsencrypt/live/thokan.cloud/fullchain.pem ~/ThoKan_cloud/docker/ssl/cert.pem
sudo cp /etc/letsencrypt/live/thokan.cloud/privkey.pem ~/ThoKan_cloud/docker/ssl/key.pem
docker restart thokan_cloud-nginx-1
